   <div class="app-sidebar sidebar-shadow">
                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            ...
                            <li class="app-sidebar__heading">MANAGE PROGRAM</li>
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="home.php?page=manage-program">
                            ...
                            <li class="app-sidebar__heading">MANAGE Teahcer</li>
                            <li>
                                <a href="#">
                                         <i class="metismenu-icon pe-7s-display2"></i>
                                         Teacher
                                    ...
                                    <ul>
                                <li>
                                    <a href="" data-toggle="modal" data-target="#modalForAssignCourse">
                                        <i class="metismenu-icon pe-7s-add-user">
                                        </i>Assign Course
                                    </a>
                                </li>
                                <li>
                                    <a href="home.php?page=manage-teachers">
                              ...
                              <ul>
                                ...
                                <li>
                                    <a href="home.php?page=question-bank">
                                        <i class="metismenu-icon pe-7s-cup">
                                        </i>Question Bank
                                    </a>
                                </li>
