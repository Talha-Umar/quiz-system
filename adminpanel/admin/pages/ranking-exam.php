<div class="app-main__outer">
 ...
 <?php 
    ...
    $selScore = $conn->query("SELECT * FROM exam_question_tbl ext INNER JOIN question_tbl eqt INNER JOIN exam_answers ea ON eqt.eqt_id = ea.quest_id WHERE ea.quest_id=ext.que_id  AND ea.axmne_id='$exmneId' AND ea.exans_status='new' ORDER BY ea.exans_id DESC");
