...
{
	$insData = $conn->query("INSERT INTO examinee_tbl(exmne_fullname,exmne_program,exmne_course,exmne_gender,exmne_birthdate,exmne_email,exmne_password) VALUES('$fullname','$programSelected','$courseSelected','$gender','$bdate','$email','$password')  ");
	if($insData)
	{
