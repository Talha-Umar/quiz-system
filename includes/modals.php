        ...
        <div class="col-md-12">
          <div class="form-group">
            ...
            <?php 
             ...
             ?>
            <input type="radio" id="name" name="asMe" value="<?php echo $selMe['exmne_fullname']; ?>">
            <label for="name"><?php echo $selMe['exmne_fullname']; ?> </label><br>
            <input type="radio" id="Anonymous" name="asMe" value="Anonymous">
