        ...
        <div class="row col-md-6 float-left">
        	<div class="main-card mb-3 card">
                <div class="card-body">
                    ...
                    <?php 
                    	$selQuest = $conn->query("SELECT * FROM 
                            exam_question_tbl ext INNER JOIN question_tbl eqt INNER JOIN exam_answers ea ON eqt.eqt_id = ea.quest_id WHERE ext.exam_id='$examId' AND ea.quest_id=ext.que_id  AND ea.axmne_id='$exmneId' AND ea.exans_status='new' ");
                    	$i = 1;
                ...
                <div class="widget-content-wrapper text-white">
                    ...
                    <div class="widget-content-right">
                        <div class="widget-numbers text-white">
                            <?php 
                                $selScore = $conn->query("SELECT * FROM exam_question_tbl ext INNER JOIN question_tbl eqt INNER JOIN exam_answers ea ON eqt.eqt_id = ea.quest_id AND eqt.exam_answer = ea.exans_answer  WHERE ea.axmne_id='$exmneId' AND ea.quest_id=ext.que_id  AND  ea.exam_id='$examId' AND ea.exans_status='new' ");
                            ?>
                            <span>
