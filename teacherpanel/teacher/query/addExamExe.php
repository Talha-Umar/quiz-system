<?php 
 ...
 else
 {
	...
	$insExam = $conn->query("INSERT INTO exam_tbl(prog_id,cou_id,ex_title,ex_time_limit,ex_questlimit_display,ex_description,ex_by) VALUES('$programSelected','$courseSelected','$examTitle','$timeLimit','$examQuestDipLimit','$examDesc','$t_id') ");
	if($insExam)
	{
